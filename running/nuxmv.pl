...
my $output_dir = $root_dir."results/";
my $translator = "MLTLConvertor -smv";
my $tool = "nuXmv";
###for KLIVE checking
my $tool_para = "-source klive.cmd";
###for BMC checking
#my $tool_para = "-source bmc.cmd";
my $tmpfile = "tmp${N}.smv";
